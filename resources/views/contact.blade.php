                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="smart-forms bmargin">
                            ...
                            <br />
                            <br />
                            <form action="{{ url('/contact/submit') }}" method="POST" id="smart-form">
                                @csrf
                                <div>
                                    <div class="section">
                                        <label class="field prepend-icon">
                                            <input type="text" name="subject" id="sendersubject"
                                    ...
                                    <div class="section colm colm6">
                                        <label class="field prepend-icon">
                                            <input type="tel" name="phone" id="telephone" class="gui-input"
                                                placeholder="TEL">
                                    ...
                                    <div class="section">
                                        <label class="field prepend-icon">
                                            <textarea class="gui-textarea" id="sendermessage" name="message" placeholder="内容"></textarea>
