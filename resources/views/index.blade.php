<x-guest-layout>
    ...
    <div class="master-slider ms-skin-default" id="masterslider">
        ...
        <div class="ms-slide slide-2" data-delay="9">
            ...
            <a class="ms-layer sbut6 yellow" style="right: 230px; top: 350px;" data-type="text" data-delay="2000"
                data-ease="easeOutExpo" data-duration="1200" data-effect="scale(1.5,1.6)">
                IT導入支援 </a>
        </div>
        <!-- end slide 2 -->
                                ...
                                <div class="cbp-item identity logos">
                                    <a href="{{ route('project.show', ['id' => $item->id]) }}" class="cbp-caption"
                                        ...
                                        <div class="cbp-caption-defaultWrap">
                                            <img id="uniform-size" src="{{ asset('images/' . $item->image) }}"
                ...
                <div class="col-md-4 col-sm-6 align-left clearfix">
                    <div class="item-holder bmargin">
                        ...
                        <div class="feature-box29">
                            ...
                            <div class="clearfix"></div>
                            <br />
                            <p>ソフトウェア開発を通して、中小企業のDX化推進支援と、人々の生活に便利なツールをご提供します。</p>
                        </div>
                    </div>
                </div>
